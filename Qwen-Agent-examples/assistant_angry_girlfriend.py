...
def app_gui():
    ...
    WebUI(agent, chatbot_config=chatbot_config).run(share=True,server_name="0.0.0.0",server_port=60015,messages=[{'role': 'assistant', 'content': [{'text': '还不快来哄哄我！'}]}])
